...
const Footer = () => {
  ...
  <nav>
    ...
    <Link href="/services" className="link link-hover">Baby Care</Link>
    <Link href="/services" className="link link-hover">Elderly Service</Link>
    <Link href="/services" className="link link-hover">Sick People Service</Link>
    <Link href="/reviews/create-review" className="link link-hover">Leave a Review</Link>
  </nav>
  <nav>
